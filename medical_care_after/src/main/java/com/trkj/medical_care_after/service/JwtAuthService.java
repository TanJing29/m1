...
import com.trkj.securityboot.exception.CustomError;
import com.trkj.securityboot.exception.CustomErrorType;
...
public class JwtAuthService {
    ...
    public String login(String username, String password) throws CustomError {
        ...
        return jwtTokenUtil.generateToken(userDetails.getUsername(),userDetails.getId()+"");
    }
